...
const HomePage = () => {
    ...
    return (
        ...
        <div className={`dark:bg-bodyDark dark:text-textDark bg-bodyLight text-textLight ${josefin.className} transition-all duration-500  min-h-screen w-full h-full pb-24 `}>
            ...
            < div className='dark:bg-containerDark dark:text-textDark bg-bodyLight text-textLight min-h-[3rem] w-[90%] m-auto -mt-6 overflow-hidden rounded-md flex items-center justify-center divide-y divide-[#d1cece] flex-col transition-all duration-500 md:max-w-2xl' >
