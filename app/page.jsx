...
const HomePage = () => {
    ...
    return (
        <div className={`${DarkTheme ? 'bg-[#161722] text-white' : 'bg-white text-[#161722]'} transition-all duration-500 min-h-screen w-full`}>
            ...
            <div className={`${DarkTheme ? 'bg-[#25273c] text-white' : 'bg-white text-[#25273c] '} gap-2 min-h-[3rem] w-[90%] m-auto -mt-6 overflow-hidden rounded-md flex items-center justify-center flex-col`}>
